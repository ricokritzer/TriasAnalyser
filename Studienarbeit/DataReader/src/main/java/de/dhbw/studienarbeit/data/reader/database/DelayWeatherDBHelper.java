...
public class DelayWeatherDBHelper
{
	...
	public static String getSQL(final String fieldOfWeahter, final String name)
	{
		return new StringBuilder().append("SELECT ")
				...
				.append("ROUND(").append(fieldOfWeahter).append(",0) AS ").append(name)
				.append(" FROM Stop, Weather, Station ").append("WHERE ")
