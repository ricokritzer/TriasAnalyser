...
public class StationSaveable implements Saveable
{
	...
	public StationSaveable(String stationID, String name, double lat, double lon, String operator, boolean observe)
	{
		super();
