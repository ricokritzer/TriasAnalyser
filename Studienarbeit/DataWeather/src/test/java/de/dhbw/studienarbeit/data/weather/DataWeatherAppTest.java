...
public class DataWeatherAppTest
{
	...
	{
		final StationDB station = new StationDB("foo", "bar", 49.0182304023, 8.40232424, "bla");
		final StationDB stationWithSimilarWeather = new StationDB("foo2", "bar2", 49.01923123, 8.40432424, "bla2");
